<aside class=layout-column-start ng-switch on=reveal>
    ...
    <div class="layout-row" ng-switch-when="case">
        <article ng-repeat="case in baseWatch.case.details">
    ...
    <div class="layout-row" ng-switch-when="bezel">
        <article ng-repeat="bezel in baseWatch.bezel.details">
    ...
    <div class="layout-row" ng-switch-when="dial">
        <article ng-repeat="dial in baseWatch.dial.details">
    ...
    <div class="layout-row" ng-switch-when="hands">
        <article ng-repeat="hands in baseWatch.hands.details">
    ...
    <div class="layout-row" ng-switch-when="strap">
        <article ng-repeat="strap in baseWatch.strap.details">
