...
//     //indices
//     $watchDoc.find('#indices_15_,#faceIndices_1_ path,#indices_24_,#indices_23_,#indices_22_,#indices_21_,#indices_20_,#indices_14_').attr({
//         'fill': '#' + colourToHex(objWatch.indices)
//     });
//     $watchDoc.find('#bigHourHand,#bigMinuteHand,#bigSecondHand,#littleHourHand,#littleMinuteHand,#littleSecondHand').attr({
//         'style': 'fill:#' + colourToHex(objWatch.indices)
//     });
//     //3 6 9
//     $watchDoc.find('#big369_1_ path').attr({
//         'fill': '#' + colourToHex(objWatch.big369)
//     });
//     // SecondMarkers
//     $watchDoc.find('#secondMarkers_1_ path').attr({
//         'fill': '#' + colourToHex(objWatch.secondMarkers)
//     });
//     // Dial
//     $watchDoc.find('#dial_1_').attr({
//         'fill': '#' + colourToHex(objWatch.dial)
//     });
//     // Second Hand
//     $watchDoc.find('#secondHand_3_ path').first().attr({
//         'fill': '#' + colourToHex(objWatch.secondHand)
//     });
//     // Logo
//     $watchDoc.find('#logo_1_ path').attr({
//         'fill': '#' + colourToHex(objWatch.logo)
//     });
//     // Dial Text
//     $watchDoc.find('#dialText_1_').parent().attr({
//         'fill': '#' + colourToHex(objWatch.dialTextColour)
//     });
//     // Dial Text Entry
...
//     //indices
//     $watchDoc.find('#indices_15_,#faceIndices_4_ path,#faceIndices_1_ path,#indices_24_,#indices_23_,#indices_22_,#indices_21_,#indices_20_,#indices_14_').attr({
//         'fill': '#' + colourToHex(objWatch.indices)
//     });
//     $watchDoc.find('#bigHourHand,#bigMinuteHand,#bigSecondHand,#littleHourHand,#littleMinuteHand,#littleSecondHand').attr({
//         'style': 'fill:#' + colourToHex(objWatch.indices)
//     });
//     //3 6 9
//     $watchDoc.find('#big369_4_ path,#big369_1_ path').attr({
//         'fill': '#' + colourToHex(objWatch.big369)
//     });
//     // SecondMarkers
//     $watchDoc.find('#secondMarkers_4_ path,#secondMarkers_1_ path').attr({
//         'fill': '#' + colourToHex(objWatch.secondMarkers)
//     });
//     // Dial
//     $watchDoc.find('#dial_4_,#dial_2_').attr({
//         'fill': '#' + colourToHex(objWatch.dial)
//     });
//     // Second Hand
//     $watchDoc.find('#secondHand_3_ path').first().attr({
...
//     });
//     // Logo
//     $watchDoc.find('#logo_1_ path,#logo_4_ path').attr({
//         'fill': '#' + colourToHex(objWatch.logo)
//     });
//     // Dial Text
//     $watchDoc.find('#dialText_1_,#dialText_4_').attr({
//         'fill': '#' + colourToHex(objWatch.dialTextColour)
//     });
//     // Dial Text Entry
...
//     //indices
//     $thisWatchDoc.find('#indices_15_,#faceIndices_1_ path,#indices_24_,#indices_23_,#indices_22_,#indices_21_,#indices_20_,#indices_14_').attr({
//         'fill': '#' + colourToHex(objWatch.indices)
//     });
//     $thisWatchDoc.find('#bigHourHand,#bigMinuteHand,#bigSecondHand,#littleHourHand,#littleMinuteHand,#littleSecondHand').attr({
//         'style': 'fill:#' + colourToHex(objWatch.indices)
//     });
//     //3 6 9
//     $thisWatchDoc.find('#big369_1_ path').attr({
//         'fill': '#' + colourToHex(objWatch.big369)
//     });
//     // SecondMarkers
//     $thisWatchDoc.find('#secondMarkers_1_ path').attr({
//         'fill': '#' + colourToHex(objWatch.secondMarkers)
//     });
//     // Dial
//     $thisWatchDoc.find('#dial_1_').attr({
//         'fill': '#' + colourToHex(objWatch.dial)
//     });
//     // Second Hand
//     $thisWatchDoc.find('#secondHand_3_ path').first().attr({
//         'fill': '#' + colourToHex(objWatch.secondHand)
//     });
//     // Logo
//     $thisWatchDoc.find('#logo_1_ path').attr({
//         'fill': '#' + colourToHex(objWatch.logo)
//     });
//     // Dial Text
//     $thisWatchDoc.find('#dialText_1_').parent().attr({
//         'fill': '#' + colourToHex(objWatch.dialTextColour)
//     });
//     // Dial Text Entry
//     if (objWatch.dialText == '') {
...
//         $watchDoc.find('#Layer_6 rect').attr({
//             'fill': '#E5E5E5'
//         });
//     } else {
//         $watchDoc.find('#Layer_6 rect').attr({
...
//     //indices
//     $watchDoc.find('#indices circle,#indices polygon,#indices path,#indices rect').attr({
//         'fill': '#' + colourToHex(objWatch.indices)
//     });
//     $watchDoc.find('#bigHourHand,#bigMinuteHand,#bigSecondHand').attr({
//         'style': 'fill:#' + colourToHex(objWatch.indices)
//     });
//     //bezelMarkers
//     $watchDoc.find('#bezelMarkers path,#bezelMarkers polygon').attr({
//         'fill': '#' + colourToHex(objWatch.bezelMarkers)
//     });
//     // Dial
//     $watchDoc.find('#dial_4_').attr({
//         'fill': '#' + colourToHex(objWatch.dial)
//     });
//     // Second Hand
//     $watchDoc.find('#SECONDHAND_2_').attr({
//         'fill': '#' + colourToHex(objWatch.secondHand)
//     });
//     // Logo
//     $watchDoc.find('#logo path,#logo rect, #whitelines_1_').attr({
//         'fill': '#' + colourToHex(objWatch.logo)
//     });
//     // Date Wheel
//     $watchDoc.find('#dateWheel_2_ path').attr({
//         'fill': '#' + colourToHex(objWatch.dateWheel)
//     });
//     // Date Number
//     $watchDoc.find('#dateNumberText,#dateNumberText_1_').parent().attr({
//         'fill': '#' + colourToHex(objWatch.dateNumber)
//     });
//     // Dial Text
//     $watchDoc.find('#dialText_2_').parent().attr({
//         'fill': '#' + colourToHex(objWatch.dialTextColour)
//     });
//     // Dial Text Entry
//     if (objWatch.dialText == '') {
...
//     // background
//     $watchDoc.find('#bgRect').attr({
//         'fill': '#D3E2EF'
//     });
//     if (BrowserDetect.browser == 'Firefox') {
//         $watchDoc.find('#smallDatePath').attr({
//             'd': 'M92,122h15'
//         });
//         $watchDoc.find('#largeDialTextPath').attr({
//             'd': 'M46,128h50'
//         });
//     }
// }
...
//     $watchDoc.find('#dateNumberText,#dateNumberText_1_').text(currentDay);
//     //indices
//     $watchDoc.find('#indices_1_ circle,#indices_1_ polygon,#indices_1_ path,#indices_1_ rect,#indices_2_ circle,#indices_2_ polygon,#indices_2_ path,,#indices_2_ rect').attr({
//         'fill': '#' + colourToHex(objWatch.indices)
//     });
//     $watchDoc.find('#bigHourHand,#bigMinuteHand,#bigSecondHand,#littleHourHand,#littleMinuteHand,#littleSecondHand').attr({
//         'style': 'fill:#' + colourToHex(objWatch.indices)
...
//     });
//     // Dial
//     $watchDoc.find('#dial_2_,#dial_4_').attr({
//         'fill': '#' + colourToHex(objWatch.dial)
//     });
//     // Second Hand
//     $watchDoc.find('#SECONDHAND_2_ path').first().attr({
//         'fill': '#' + colourToHex(objWatch.secondHand)
//     });
//     // Logo
//     $watchDoc.find('#logo path,#logo_1_ path,#logo rect,#logo_1_ rect,#whitelines_2_,#whitelines_1_').attr({
//         'fill': '#' + colourToHex(objWatch.logo)
//     });
//     // Date Wheel
//     $watchDoc.find('#dateWheel_1_ path,#dateWheel_2_ path').attr({
//         'fill': '#' + colourToHex(objWatch.dateWheel)
//     });
//     // Date Number
//     $watchDoc.find('#dateNumberText,#dateNumberText_1_').parent().attr({
...
//     });
//     // Dial Text
//     $watchDoc.find('#dialText_2_,#dialText_5_').parent().attr({
//         'fill': '#' + colourToHex(objWatch.dialTextColour)
//     });
//     // Dial Text Entry
//     if (objWatch.dialText == '') {
...
//             'd': 'M323,129h12'
//         });
//         $watchDoc.find('#largeDatePath').attr({
//             'd': 'M175,137h40'
//         });
//         $watchDoc.find('#smallDialTextPath').attr({
//             'd': 'M290,136h20'
//         });
//         $watchDoc.find('#largeDialTextPath').attr({
//             'd': 'M81,152h75'
...
//     });
//     // Logo
//     $watchDoc.find('#logo path,#whitelines_1_').attr({
//         'fill': '#' + colourToHex(objWatch.logo)
//     });
//     // Date Wheel
//     $watchDoc.find('#dateWheel_1_ path').attr({
//         'fill': '#' + colourToHex(objWatch.dateWheel)
//     });
//     // Date Number
//     $watchDoc.find('#dateNumberText,#dateNumberText_1_').parent().attr({
...
//     });
//     // Second Hand
//     $watchDoc.find('#SECONDHAND_2_ path').attr({
//         'fill': '#' + colourToHex(objWatch.secondHand)
//     });
//     // Logo
//     $watchDoc.find('#logo path,#whitelines_1_').attr({
...
//     $watchDoc.find('#dateNumberText,#dateNumberText_1_').text(currentDay);
//     //indices
//     $watchDoc.find('#indices_3_ circle,#indices_3_ polygon,#indices_3_ path,#indices_4_ circle,#indices_4_ polygon,#indices_4_ path,#indicesBorders circle,#indicesBorders polygon,#indicesBorders path,#indices_2_ circle,#indices_2_ polygon,#indices_2_ path').attr({
//         'fill': '#' + colourToHex(objWatch.indices)
//     });
//     $watchDoc.find('#bigHourHand,#bigMinuteHand,#bigSecondHand,#littleHourHand,#littleMinuteHand,#littleSecondHand,#bigTwentyFourHourHand,#littleTwentyFourHourHand').attr({
//         'style': 'fill:#' + colourToHex(objWatch.indices)
//     });
//     //bezelMarkers
//     $watchDoc.find('#bezelMarkers path,#bezelMarkers polygon,#bezelMarkers circle').attr({
//         'fill': '#' + colourToHex(objWatch.bezelMarkers)
//     });
...
//     }
//     // 24 HOUR HAND
//     $watchDoc.find('#_x32_4hourhand path').attr({
//         'fill': '#' + colourToHex(objWatch.twentyFourHourHand)
//     });
//     // Dial
//     $watchDoc.find('#dial_2_,#dial_1_').attr({
//         'fill': '#' + colourToHex(objWatch.dial)
//     });
//     // Second Hand
//     $watchDoc.find('#SECONDHAND_2_ path').first().attr({
...
//     });
//     // Logo
//     $watchDoc.find('#logo path,#logo_1_ path').attr({
//         'fill': '#' + colourToHex(objWatch.logo)
//     });
//     // Date Wheel
//     $watchDoc.find('#dateWheel_2_ path,#dateWheel_3_ path').attr({
//         'fill': '#' + colourToHex(objWatch.dateWheel)
//     });
//     // Date Number
//     $watchDoc.find('#dateNumberText,#dateNumberText_1_').parent().attr({
...
//     $watchDoc.find('#dateNumberText,#dateNumberText_1_').text(currentDay);
//     //indices
//     $watchDoc.find('#indices circle,#indices polygon,#indices path,#indices rect,#indices_1_ circle,#indices_1_ polygon,#indices_1_ path,#indices_1_ rect').attr({
//         'fill': '#' + colourToHex(objWatch.indices)
//     });
//     $watchDoc.find('#bigHourHand,#bigMinuteHand,#bigSecondHand,#littleHourHand,#littleMinuteHand,#littleSecondHand').attr({
//         'style': 'fill:#' + colourToHex(objWatch.indices)
//     });
//     // Dial
//     $watchDoc.find('#dial_1_,#dial_3_').attr({
//         'fill': '#' + colourToHex(objWatch.dial)
//     });
//     // Second Hand
//     $watchDoc.find('#SECONDHAND_2_').attr({
...
//     });
//     // Date Wheel
//     $watchDoc.find('#dateWheel_2_ path,#dateWheel_4_ path').attr({
//         'fill': '#' + colourToHex(objWatch.dateWheel)
//     });
//     // Date Number
//     $watchDoc.find('#dateNumberText,#dateNumberText_1_').parent().attr({
...
//     //indices
//     $watchDoc.find('#indices polygon,#indices path,#indices circle,#indices rect').attr({
//         'fill': '#' + colourToHex(objWatch.indices)
//     });
//     $watchDoc.find('#bigHourHand,#bigMinuteHand,#bigSecondHand').attr({
//         'style': 'fill:#' + colourToHex(objWatch.indices)
...
//     });
//     // Date Number
//     $watchDoc.find('#dateNumberText').parent().attr({
//         'fill': '#' + colourToHex(objWatch.dateNumber)
//     });
//     // Dial Text
//     $watchDoc.find('#dialText_2_').parent().attr({
...
//         'fill': '#' + colourToHex(objWatch.indices)
//     });
//     $watchDoc.find('#bigHourHand,#bigMinuteHand,#bigSecondHand,#bigTwentyFourHourHand').attr({
//         'style': 'fill:#' + colourToHex(objWatch.indices)
//     });
//     //bezelMarkers
//     $watchDoc.find('#bezelMarkers path,#bezelMarkers polygon,#bezelMarkers circle').attr({
...
//     }
//     // 24 HOUR HAND
//     $watchDoc.find('#x32_4hourhand_1').attr({
//         'fill': '#' + colourToHex(objWatch.twentyFourHourHand)
//     });
...
//     $watchDoc.find('#dateNumberText,#dateNumberText_1_').text(currentDay);
//     //indices
//     $watchDoc.find('#indices circle,#indices polygon,#indices path,#indices rect,#indices_1_ polygon,#indices_1_ path,#indices_1_ circle,#indices_1_ rect').attr({
//         'fill': '#' + colourToHex(objWatch.indices)
//     });
//     $watchDoc.find('#bigHourHand,#bigMinuteHand,#bigSecondHand,#littleHourHand,#littleMinuteHand,#littleSecondHand,#bigTwentyFourHourHand,#littleTwentyFourHourHand').attr({
//         'style': 'fill:#' + colourToHex(objWatch.indices)
...
//     }
//     // 24 HOUR HAND
//     $watchDoc.find('#_x32_4hourhand polygon').attr({
//         'fill': '#' + colourToHex(objWatch.twentyFourHourHand)
//     });
//     // Dial
//     $watchDoc.find('#dial_2_,#dial_1_').attr({
...
//     });
//     // Dial
//     $watchDoc.find('#dial_3_').attr({
//         'fill': '#' + colourToHex(objWatch.dial)
//     });
//     // Second Hand
//     $watchDoc.find('#SECONDHAND_2_').first().attr({
//         'fill': '#' + colourToHex(objWatch.secondHand)
//     });
//     // Logo
//     $watchDoc.find('#logo path').attr({
...
//     var $watchDoc = $('#myDesigns_' + watchID).contents();
//     //indices
//     $watchDoc.find('#indices path').attr({
//         'fill': '#' + colourToHex(objWatch.indices)
//     });
//     $watchDoc.find('#littleHourHand,#littleMinuteHand').attr({
//         'style': 'fill:#' + colourToHex(objWatch.indices)
//     });

//     //daytonaText
//     $watchDoc.find('#daytonaText_2_ path').attr({
//         'fill': '#' + colourToHex(objWatch.daytonaText)
//     });
//     //chronoRings
//     $watchDoc.find('#chronoRings path').attr({
//         'fill': '#' + colourToHex(objWatch.chronoRings)
//     });
//     if (objWatch.chronoRings != 'metallic') {
//         $watchDoc.find('#chronoRingsMetallic').hide();
//     }
//     //chronoHands
//     $watchDoc.find('#chronoHands path').attr({
//         'fill': '#' + colourToHex(objWatch.chronoHands)
//     });
//     //chronoDials
//     $watchDoc.find('#chronoDials circle').attr({
//         'fill': '#' + colourToHex(objWatch.chronoDials)
//     });
//     //chronoMarkers
//     $watchDoc.find('#chronoMarkers_2_').attr({
//         'fill': '#' + colourToHex(objWatch.chronoMarkers)
//     });
//     // SecondMarkers
//     $watchDoc.find('#secondMarkers_2_').attr({
//         'fill': '#' + colourToHex(objWatch.secondMarkers)
//     });
//     // MinuteMarkers
//     $watchDoc.find('#fiveMinuteMarkers path').attr({
//         'fill': '#' + colourToHex(objWatch.minuteMarkers)
//     });
//     if (objWatch.minuteMarkers != 'metallic') {
//         $watchDoc.find('#fiveMinuteMarkersMetallic').hide();
//     }
//     // Dial
//     $watchDoc.find('#dial_5_').attr({
//         'fill': '#' + colourToHex(objWatch.dial)
//     });
...
//     }
//     // Second Hand
//     $watchDoc.find('#secondHand path').attr({
//         'fill': '#' + colourToHex(objWatch.secondHand)
//     });
//     // Logo
//     $watchDoc.find('#logo path').attr({
...
//     }
//     // Dial Text
//     $watchDoc.find('#dialText_4_').parent().attr({
//         'fill': '#' + colourToHex(objWatch.dialTextColour)
//     });
//     // Dial Text Entry
//     $watchDoc.find('#dialText_1_').text(objWatch.dialText);
...
//     //indices
//     $watchDoc.find('#indices_1_ path,#indices path').attr({
//         'fill': '#' + colourToHex(objWatch.indices)
//     });
//     $watchDoc.find('#bigHourHand,#bigMinuteHand,#littleHourHand,#littleMinuteHand').attr({
//         'style': 'fill:#' + colourToHex(objWatch.indices)
//     });

//     //daytonaText
//     $watchDoc.find('#daytonaText_1_ path,#daytonaText_2_ path').attr({
//         'fill': '#' + colourToHex(objWatch.daytonaText)
//     });
//     //chronoRings
//     $watchDoc.find('#chronoRings_1_ path,#chronoRings path').attr({
//         'fill': '#' + colourToHex(objWatch.chronoRings)
//     });
//     if (objWatch.chronoRings != 'metallic') {
//         chronoDialOn = false;
//     }
//     //chronoHands
//     $watchDoc.find('#chronoHands_1_ path,#chronoHands path').attr({
//         'fill': '#' + colourToHex(objWatch.chronoHands)
//     });
...
//     }
//     //chronoDials
//     $watchDoc.find('#chronoDials_1_ circle,#chronoDials circle,#chronoDials_1_ path').attr({
//         'fill': '#' + colourToHex(objWatch.chronoDials)
//     });
...
//     }
//     //chronoMarkers
//     $watchDoc.find('#chronoMarkers_1_,#chronoMarkers_2_').attr({
//         'fill': '#' + colourToHex(objWatch.chronoMarkers)
//     });
...
//     }
//     // SecondMarkers
//     $watchDoc.find('#secondMarkers_2_,#secondMarkers_1_').attr({
//         'fill': '#' + colourToHex(objWatch.secondMarkers)
//     });
//     // MinuteMarkers
//     $watchDoc.find('#fiveMinuteMarkers path,#fiveMinuteMarkers_1_ path').attr({
//         'fill': '#' + colourToHex(objWatch.minuteMarkers)
//     });
//     if (objWatch.minuteMarkers != 'metallic') {
...
//     }
//     // Dial
//     $watchDoc.find('#dial_1_,#dial_5_').attr({
//         'fill': '#' + colourToHex(objWatch.dial)
//     });
//     if (objWatch.dial != 'black') {
//         chronoDialOn = false;
...
//     });
//     // Logo
//     $watchDoc.find('#logo_2_ path,#logo path').attr({
//         'fill': '#' + colourToHex(objWatch.logo)
//     });
//     if (objWatch.logo != 'white') {
...
//     }
//     // Dial Text
//     $watchDoc.find('#dialText_4_,#dialText_1_').parent().attr({
//         'fill': '#' + colourToHex(objWatch.dialTextColour)
//     });
//     // Dial Text Entry
//     $watchDoc.find('#dialText_1_,#dialText_4_').text(objWatch.dialText);
...
//     });
//     //chronoRings
//     $watchDoc.find('#chronoRings_1_ path').attr({
//         'fill': '#' + colourToHex(objWatch.chronoRings)
//     });
//     if (objWatch.chronoRings != 'metallic') {
//         $watchDoc.find('#chronoRingsMetallic').hide();
...
//     });
//     // MinuteMarkers
//     $watchDoc.find('#fiveMinuteMarkers_1_ path').attr({
//         'fill': '#' + colourToHex(objWatch.minuteMarkers)
//     });
//     if (objWatch.minuteMarkers != 'metallic') {
//         $watchDoc.find('#fiveMinuteMarkersMetallic').hide();
...
//     }
//     // Second Hand
//     $watchDoc.find('#secondHand path').first().attr({
//         'fill': '#' + colourToHex(objWatch.secondHand)
//     });
//     // Logo
//     $watchDoc.find('#logo path').attr({
...
//     });
//     //bezelMarkers
//     $watchDoc.find('#bezelMarkers path').attr({
//         'fill': '#' + colourToHex(objWatch.bezelMarkers)
//     });
//     // 24 HOUR HAND
//     $watchDoc.find('#_x32_4hourhand path').attr({
...
//     });
//     // Date Wheel
//     $watchDoc.find('#dateWheel path,#dateWheel_1_ path').attr({
//         'fill': '#' + colourToHex(objWatch.dateWheel)
//     });
//     // Date Number
//     $watchDoc.find('#dateNumberText,#dateNumberText_1_').parent().attr({
...
//         'fill': '#' + colourToHex(objWatch.dialTextColour)
//     });
//     $watchDoc.find('#explorerIIText path').attr({
//         'fill': '#' + colourToHex(objWatch.dialTextColour)
//     });
//     // Dial Text Entry
//     if (objWatch.dialText == '') {
...
//     $watchDoc.find('#dateNumberText,#dateNumberText_1_').text(currentDay);
//     //indices
//     $watchDoc.find('#indices circle,#indices polygon,#indices path,#indices rect,#indices_2_ rect,#indices_2_ circle,#indices_2_ polygon,#indices_2_ path').attr({
//         'fill': '#' + colourToHex(objWatch.indices)
//     });
//     $watchDoc.find('#bigHourHand,#bigMinuteHand,#bigTwentyFourHourHand,#bigSecondHand,#littleHourHand,#littleMinuteHand,#littleTwentyFourHourHand,#littleSecondHand').attr({
//         'style': 'fill:#' + colourToHex(objWatch.indices)
//     });
//     //bezelMarkers
//     $watchDoc.find('#bezelMarkers path').attr({
...
//     });
//     // Dial
//     $watchDoc.find('#dial_3_,#dial_2_').attr({
//         'fill': '#' + colourToHex(objWatch.dial)
//     });
//     // Second Hand
//     $watchDoc.find('#SECONDHAND_2_ path').first().attr({
...
//     });
//     // Logo
//     $watchDoc.find('#logo_3_ path,#logo_1_ path').attr({
//         'fill': '#' + colourToHex(objWatch.logo)
//     });
//     // Date Wheel
//     $watchDoc.find('#dateWheel_1_ path,#dateWheel_3_ path').attr({
//         'fill': '#' + colourToHex(objWatch.dateWheel)
//     });
//     // Date Number
//     $watchDoc.find('#dateNumberText,#dateNumberText_1_').parent().attr({
...
//         'fill': '#' + colourToHex(objWatch.dialTextColour)
//     });
//     $watchDoc.find('#explorerIIText path,#explorerIIText_1_ path').attr({
//         'fill': '#' + colourToHex(objWatch.dialTextColour)
//     });
//     // Dial Text Entry
//     if (objWatch.dialText == '') {
...
//     $watchDoc.find('#dateNumberText,#dateNumberText_1_').text(currentDay);
//     //indices
//     $watchDoc.find('#indices_2_ circle,#indices_2_ polygon,#indices_2_ path,#indices_2_ rect').attr({
//         'fill': '#' + colourToHex(objWatch.indices)
//     });
//     $watchDoc.find('#bigHourHand,#bigMinuteHand,#bigSecondHand,#bigTwentyFourHourHand').attr({
//         'style': 'fill:#' + colourToHex(objWatch.indices)
...
//     // stitching
//     $watchDoc.find('#stitching path').attr({
//         'fill': '#' + colourToHex(objWatch.strapStitching)
//     });
...
//     });
//     //chronoMarkers
//     $watchDoc.find('#chronoMarkers,#chronoMarkers_1_').attr({
//         'fill': '#' + colourToHex(objWatch.chronoMarkers)
//     });
//     // MinuteMarkers
//     $watchDoc.find('#secondMarkers path,#secondMarkers_1_ path').attr({
//         'fill': '#' + colourToHex(objWatch.minuteMarkers)
//     });
//     // Dial
//     $watchDoc.find('#dial_1_,#dial_2_').attr({
//         'fill': '#' + colourToHex(objWatch.dial)
//     });
//     // Second Hand
//     $watchDoc.find('#secondHand path').attr({
...
//     });
//     // Logo
//     $watchDoc.find('#logo,#logo_1_').attr({
//         'fill': '#' + colourToHex(objWatch.logo)
//     });
//     // Date Wheel
//     $watchDoc.find('#dateWheel_1_ path,#dateWheel path').attr({
//         'fill': '#' + colourToHex(objWatch.dateWheel)
//     });
//     // Date Number
//     $watchDoc.find('#dateNumberText,#dateNumberText_1_').parent().attr({
...
//     });
//     // stitching
//     $watchDoc.find('#stitch path').attr({
//         'fill': '#' + colourToHex(objWatch.strapStitching)
//     });
...
//     });
//     // MinuteMarkers
//     $watchDoc.find('#secondMarkers path').attr({
//         'fill': '#' + colourToHex(objWatch.minuteMarkers)
//     });
//     //chronoHands
//     $watchDoc.find('#chronoHands path').attr({
...
//     });
//     //chronoMarkers
//     $watchDoc.find('#chronoMarkers').attr({
//         'fill': '#' + colourToHex(objWatch.chronoMarkers)
//     });
//     // Dial
//     $watchDoc.find('#dial_2_').attr({
...
//     });
//     // Second Hand
//     $watchDoc.find('#secondHand_1_').first().attr({
//         'fill': '#' + colourToHex(objWatch.secondHand)
//     });
//     // Logo
//     $watchDoc.find('#logo').attr({
//         'fill': '#' + colourToHex(objWatch.logo)
//     });
//     // background
//     $watchDoc.find('#bgRect').attr({
...
//     });
//     // Date Wheel
//     $watchDoc.find('#dateWheel_1_').attr({
//         'fill': '#' + colourToHex(objWatch.dateWheel)
//     });
//     // Date Number
//     $watchDoc.find('#dateNumberText').parent().attr({
...
//     });
//     // Logo
//     $watchDoc.find('#logo path,#logo polygon').attr({
//         'fill': '#' + colourToHex(objWatch.logo)
//     });
//     // Date Wheel
//     $watchDoc.find('#dateWheel').attr({
...
//     });
//     // Logo
//     $watchDoc.find('#logo path,#logo_1_ path,#logo polygon,#logo_1_ polygon').attr({
//         'fill': '#' + colourToHex(objWatch.logo)
//     });
//     // Date Wheel
//     $watchDoc.find('#dateWheel_1_,#dateWheel').attr({
//         'fill': '#' + colourToHex(objWatch.dateWheel)
//     });
//     // Date Number
//     $watchDoc.find('#dateNumberText,#dateNumberText_1_').parent().attr({
...
//     });
//     //minute marker
//     $watchDoc.find('#fiveMinuteMarkers_3_').attr({
//         'fill': '#' + colourToHex(objWatch.minuteMarkers)
//     });
//     // SecondMarkers
//     $watchDoc.find('#secondMarkers_1_ path').attr({
...
//         'fill': '#' + colourToHex(objWatch.dialTextColour)
//     });
//     $watchDoc.find('#milgaussText path').attr({
//         'fill': '#' + colourToHex(objWatch.dialTextColour)
//     });
//     // Dial Text Entry
//     if (objWatch.dialText == '') {
...
//     var $watchDoc = $('#enquiryWatch').contents();
//     //indices
//     $watchDoc.find('#indices_1_ path,#indices_2_ path,').attr({
//         'fill': '#' + colourToHex(objWatch.indices)
//     });
//     $watchDoc.find('#bigHourHand,#bigMinuteHand,#littleHourHand,#littleMinuteHand').attr({
//         'style': 'fill:#' + colourToHex(objWatch.indices)
//     });
//     //minute marker
//     $watchDoc.find('#fiveMinuteMarkers_3_,#fiveMinuteMarkers_1_').attr({
//         'fill': '#' + colourToHex(objWatch.minuteMarkers)
//     });
//     // SecondMarkers
//     $watchDoc.find('#secondMarkers path,#secondMarkers_2_ path').attr({
//         'fill': '#' + colourToHex(objWatch.secondMarkers)
//     });
//     // Dial
//     $watchDoc.find('#dial_4_,#dial_2_').attr({
...
//     });
//     // Logo
//     $watchDoc.find('#logo_1_ path, #logo_2_ path').attr({
//         'fill': '#' + colourToHex(objWatch.logo)
//     });
//     if (objWatch.logo == 'white') {
...
//         'fill': '#' + colourToHex(objWatch.dialTextColour)
//     });
//     $watchDoc.find('#milgaussText path,#milgaussText_1_ path').attr({
//         'fill': '#' + colourToHex(objWatch.dialTextColour)
//     });
//     // Dial Text Entry
//     if (objWatch.dialText == '') {
...
//     //console.log($thisWatchDoc);
//     //indices
//     $thisWatchDoc.find('#indices_2_').attr({
//         'fill': '#' + colourToHex(objWatch.indices)
//     });
//     $thisWatchDoc.find('#littleHourHand,#littleMinuteHand').attr({
//         'style': 'fill:#' + colourToHex(objWatch.indices)
//     });
//     //minute marker
//     $thisWatchDoc.find('#fiveMinuteMarkers_3_').attr({
//         'fill': '#' + colourToHex(objWatch.minuteMarkers)
//     });
//     // SecondMarkers
//     $thisWatchDoc.find('#secondMarkers_1_ path').attr({
...
//     });
//     // Second Hand
//     $thisWatchDoc.find('#SECONDHAND_2_').attr({
//         'fill': '#' + colourToHex(objWatch.secondHand)
//     });
//     // Logo
//     $thisWatchDoc.find('#logo_1_ path').attr({
...
//     }
//     // Dial Text
//     $thisWatchDoc.find('#dialText_2_').parent().attr({
//         'fill': '#' + colourToHex(objWatch.dialTextColour)
//     });
//     $thisWatchDoc.find('#milgaussText path').attr({
//         'fill': '#' + colourToHex(objWatch.dialTextColour)
//     });
//     // Dial Text Entry
//     if (objWatch.dialText == '') {
...
//     var $watchDoc = $('#enquiryWatch').contents();
//     //indices
//     $watchDoc.find('#indices_1_,#indices_4_').attr({
//         'fill': '#' + colourToHex(objWatch.indices)
//     });
//     $watchDoc.find('#bigHourHand,#bigMinuteHand,#littleHourHand,#littleMinuteHand').attr({
//         'style': 'fill:#' + colourToHex(objWatch.indices)
//     });
//     //minute marker
//     $watchDoc.find('#fiveMinuteMarkers_1_ path,#fiveMinuteMarkers_2_ path').attr({
//         'fill': '#' + colourToHex(objWatch.minuteMarkers)
//     });
//     // SecondMarkers
//     $watchDoc.find('#secondMarkers_1_ path,#secondMarkers_2_ path').attr({
//         'fill': '#' + colourToHex(objWatch.secondMarkers)
//     });
//     // Dial
//     $watchDoc.find('#dial_3_,#dial_5_').attr({
//         'fill': '#' + colourToHex(objWatch.dial)
//     });
//     // Second Hand
//     $watchDoc.find('#SECONDHAND_2_').attr({
...
//     //console.log($thisWatchDoc);
//     //indices
//     $thisWatchDoc.find('#indices_1_').attr({
//         'fill': '#' + colourToHex(objWatch.indices)
//     });
//     $thisWatchDoc.find('#littleHourHand,#littleMinuteHand').attr({
//         'style': 'fill:#' + colourToHex(objWatch.indices)
//     });
//     //minute marker
//     $thisWatchDoc.find('#fiveMinuteMarkers path').attr({
//         'fill': '#' + colourToHex(objWatch.minuteMarkers)
//     });
//     // SecondMarkers
//     $thisWatchDoc.find('#secondMarkers_1_ path').attr({
...
//     });
//     // Dial
//     $thisWatchDoc.find('#dial_2_').attr({
//         'fill': '#' + colourToHex(objWatch.dial)
//     });
//     // Second Hand
//     $thisWatchDoc.find('#SECONDHAND_2_').attr({
...
//     });
//     // Logo
//     $thisWatchDoc.find('#logo path').attr({
//         'fill': '#' + colourToHex(objWatch.logo)
//     });
//     if (objWatch.logo == 'black') {
...
//         'fill': '#' + colourToHex(objWatch.secondHand)
//     });
//     $watchDoc.find('#minuteHand path').eq(2).attr({
//         'fill': '#' + colourToHex(objWatch.secondHand)
//     });
//     $watchDoc.find('#hourHand path').last().attr({
//         'fill': '#' + colourToHex(objWatch.secondHand)
//     });
//     // Indices
//     $watchDoc.find('#luminescentIndices path, #luminescentIndices ellipse, #luminescentIndices_1_ path,#luminescentIndices_1_ ellipse').attr({
//         'fill': '#' + colourToHex(objWatch.indices)
//     });
//     $watchDoc.find('#luminescentIndices line, #luminescentIndices_1_ line').attr({
//         'stroke': '#' + colourToHex(objWatch.indices)
//     });
//     $watchDoc.find('#bigHourHand,#bigMinuteHand,#littleHourHand,#littleMinuteHand').attr({
//         'style': 'stroke:#' + colourToHex(objWatch.indices)
//     });
//     $watchDoc.find('#bigSecondHand,#littleSecondHand').attr({
//         'style': 'fill:#' + colourToHex(objWatch.indices)
//     });
//     // Dial
//     $watchDoc.find('#dial_1_,#dial').attr({
//         'fill': '#' + colourToHex(objWatch.dial)
//     });
//     // Five Minute Markers
//     $watchDoc.find('#fiveMinuteMarkers path,#fiveMinuteMarkers_1_ path').attr({
//         'fill': '#' + colourToHex(objWatch.fiveMinuteMarkers)
//     });
//     $watchDoc.find('#fiveMinuteMarkers line,#fiveMinuteMarkers_1_ line').attr({
//         'stroke': '#' + colourToHex(objWatch.fiveMinuteMarkers)
//     });
...
//     });
//     // Date Wheel
//     $watchDoc.find('#dateWheel,#dateWheel_1_').attr({
//         'fill': '#' + colourToHex(objWatch.dateWheel)
//     });
//     // Date Number
//     $watchDoc.find('#dateNumberText_1_,#dateNumberText').parent().attr({
//         'fill': '#' + colourToHex(objWatch.dateNumber)
//     });
//     // Dial Text
//     $watchDoc.find('#dialText_2_,#dialText_4_').parent().attr({
//         'fill': '#' + colourToHex(objWatch.dialTextColour)
//     });
//     $watchDoc.find('#dialText_2_,#dialText_4_').text(objWatch.dialText);

//     // stitching
//     $watchDoc.find('#strapStitching path').attr({
//         'fill': '#' + colourToHex(objWatch.strapStitching)
//     });
...
//         'fill': '#' + colourToHex(objWatch.fiveMinuteMarkers)
//     });
//     $watchDoc.find('#fiveMinuteMarkers line').attr({
//         'stroke': '#' + colourToHex(objWatch.fiveMinuteMarkers)
//     });
//     // indices
//     $watchDoc.find('#luminescentIndices path, #luminescentIndices ellipse').attr({
//         'fill': '#' + colourToHex(objWatch.indices)
//     });
//     $watchDoc.find('#luminescentIndices line').attr({
//         'stroke': '#' + colourToHex(objWatch.indices)
//     });
//     $watchDoc.find('#littleHourHand,#littleMinuteHand').attr({
//         'style': 'stroke:#' + colourToHex(objWatch.indices)
//     });
//     $watchDoc.find('#littleSecondHand').attr({
//         'style': 'fill:#' + colourToHex(objWatch.indices)
//     });

//     // Dial
//     $watchDoc.find('#dial').attr({
//         'fill': '#' + colourToHex(objWatch.dial)
//     });
...
//         globals.templates.slider.css({
//             'marginLeft': (0 - globals.templates.slideWidth),
//             'width': globals.templates.slideWidth * (globals.templates.sliderTrueLength + 2)
//         });
//     } else {
...
//         globals.templates.slider.animate({
//             'marginLeft': '-=' + globals.templates.slideWidth + 'px'
//         }, 600, 'easeInOutExpo', handleAfterSlideMove);
//     } else {
//         $(document).off('click', '.sliderArrow', handleMoveSlide);
//         globals.templates.slider.animate({
//             'marginLeft': '+=' + globals.templates.slideWidth + 'px'
...
//         globals.fbSharer.overlays.main.css({
//             top: vp.top + 50,
//             left: Math.round(vp.width / 2) - 350
//         }).fadeIn('fast');
